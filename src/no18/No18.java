...
public class No18 {
    ...
    public static void main(String[] args) {
        BinaryTreeNode rootA = BinaryTreeUtils.createBinaryTreeByArray(
                new Integer[]{8, 8, 7, 9, 2, null, null, null, null, 4, 7}, 0);

        BinaryTreeNode rootB = BinaryTreeUtils.createBinaryTreeByArray(
                new Integer[]{8, 9, 2}, 0);
    ...
    private boolean hasSubTree(BinaryTreeNode n1, BinaryTreeNode n2) {
        if (n1 == null || n2 == null) {
            return false;
        }
        List<BinaryTreeNode> rootList = new ArrayList<>();
        ...
        for (BinaryTreeNode root : rootList) {
     ...
     * */
    private boolean containsBinaryTree(BinaryTreeNode n1, BinaryTreeNode n2) {
        if (n2 == null) {
            return true;
        }
        if (n1 == null) {
